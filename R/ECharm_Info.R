ECharm_Info=function(solution="1:2.5"){
  fromServer2=("https://docs.google.com/spreadsheets/d/e/2PACX-1vTRcGLaM3PyMDB0abd8r1VE0OW6TWQ5QzrINjW00oiwS_SYBXM2RIJhqw9hnAeP9ePATdix7HyDjgda/pub?output=csv")
  fromServer2.5=("https://docs.google.com/spreadsheets/d/e/2PACX-1vRs69jpFKSO-t-iCJAL_5Y76H6N1s39XXBQcgTDx9cZ6N0chf1fI13FkxiaQYLX2n-34wEqOQSTTTTb/pub?output=csv")
  fromServer5=("https://docs.google.com/spreadsheets/d/e/2PACX-1vQBDSv0JeMNwIevV4BgnhKCrsSG_EcseHxPxGCNAgMSAN1ikMg88mb7r05KCP7HEopna-J1Jkb3BjNO/pub?output=csv")
  ...
  if(solution=="1:2"){
    ...
    get_info(fromServer2.5)
  }
  else if(solution == "1:5"){
    get_info(fromServer5)
  }
}
