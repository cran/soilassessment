stoneSuit=function(value, crop="wheat"){
  ...
  else if(crop=="castor"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="rapeseed"){suitclass=ifelse(value<15,1,ifelse(value<35,2,ifelse(value<50,3,4)))}
  else if(crop=="mustard"){suitclass=ifelse(value<15,1,ifelse(value<35,2,ifelse(value<50,3,4)))}
  ...
  else if(crop=="coffee"){suitclass=ifelse(value<35,1,ifelse(value<60,2,ifelse(value<75,3,4)))}
  else if(crop=="rubber"){suitclass=ifelse(value<15,1,ifelse(value<35,2,ifelse(value<50,3,4)))}
  else if(crop=="jute"){suitclass=ifelse(value<15,1,ifelse(value<35,2,ifelse(value<50,3,4)))}
  else if(crop=="saffron"){suitclass=ifelse(value<15,1,ifelse(value<35,2,ifelse(value<50,3,4)))}
  ...
  else if(crop=="carrot"){suitclass=ifelse(value<10,1,ifelse(value<25,2,ifelse(value<35,3,4)))}
  ...
  else if(crop=="pomegranate"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="banana"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="watermelon"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="melon"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="pineaple"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  ...
  else if(crop=="broccoli"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  ...
  else if(crop=="pumpkin"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}

  #Soil tonniness % suitability classes for spices
  else if(crop=="ginger"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="onion"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="chilli"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="pepper"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="cardamom"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="vanilla"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
  else if(crop=="lemongrass"){suitclass=ifelse(value<15,1,ifelse(value<35,2,ifelse(value<50,3,4)))}
  else if(crop=="tumeric"){suitclass=ifelse(value<3,1,ifelse(value<15,2,ifelse(value<35,3,4)))}
